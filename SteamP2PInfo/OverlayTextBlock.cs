...
namespace SteamP2PInfo
{
    ...
    public class OverlayTextBlock : FrameworkElement
    {
        ...
        {
            (dependencyObject as OverlayTextBlock)?.UpdatePen();
        }
        ...
        public static readonly DependencyProperty TextTrimmingProperty = DependencyProperty.Register(
          ...
          typeof(TextTrimming),
          typeof(OverlayTextBlock),
          new FrameworkPropertyMetadata(TextTrimming.None, OnFormattedTextUpdated));
        ...
        public static readonly DependencyProperty TypefaceProperty = DependencyProperty.Register(
          "Typeface",
          typeof(string),
          typeof(OverlayTextBlock),
          new FrameworkPropertyMetadata("Segoe UI, 20.25pt", OnFormattedTextUpdated));
        ...
        {
            var outlinedTextBlock = (OverlayTextBlock)dependencyObject;
        ...
        private void UpdateFormattedText()
        {
            ...
            if (font.Strikeout) textDecorations.Add(TextDecorations.Strikethrough);
            if (font.Underline) textDecorations.Add(TextDecorations.Underline);
